...
let bikerPositionTable = [
    MichaelVowesh = new PositionTable(13,'Michael Vowesh', 'Guatemala', 'R1250GS', 36),
    LuisPalmieri = new PositionTable(10,'Luis Palmieri', 'Guatemala', 'R1250GS', 34),
    AndresVega = new PositionTable(16,'Andres Vega', 'Guatemala', 'R1250GS', 27),
    DiegoMayen = new PositionTable(2,'Diego Mayen', 'Guatemala', 'R1250GS', 23),
    LuisGonzalez = new PositionTable(11,'Luis González', 'Guatemala', 'R1250GS', 23),
    CarlosPortillo = new PositionTable(19,'Carlos Portillo', 'Guatemala', 'R1250GS', 22),
    LuisLopez = new PositionTable(8,'Luis Lopez', 'Guatemala', 'R1250GS', 17),
    VictorCaceres = new PositionTable(12,'Victor Cacerez', 'Guatemala', 'R1250GS', 17),
    CarlosRamos = new PositionTable(3,'Carlos Ramos', 'Guatemala', 'R1250GS', 16),
    ByronMacaria = new PositionTable(3, 'Byron Macaria', 'Guatemala', 'R1250GS',16),
    BryanCucum = new PositionTable(17,'Bryan Cucum', 'Guatemala', 'R1250GS', 15),
    AndreGuillen = new PositionTable(27,'Andres Guillen', 'Guatemala', 'R1250GS', 15),
    RicardoValenzuela = new PositionTable(32,'Ricardo Valenzuela', 'Guatemala', 'R1250GS', 15),
    LuisPira = new PositionTable(14,'Luis Pira', 'Guatemala', 'R1250GS', 14),
    JulioCastellanos = new PositionTable(26,'Julio Castellanos', 'Guatemala', 'R1250GS', 13),
    RolandoPalma = new PositionTable(33,'Rolando Palma', 'Guatemala', 'R1250GS', 12),
    ClaudioCucum = new PositionTable(18,'Claudio Cucum', 'Guatemala', 'R1250GS', 11),
    JoseBonilla = new PositionTable(30,'José Bonilla', 'Guatemala', 'R1250GS', 11),
    BryanHernandez = new PositionTable(7,'Bryan Hernández', 'Guatemala', 'R1250GS', 10),
    JorgeRevolorio = new PositionTable(29,'Jorge Revolorio', 'Guatemala', 'R1250GS', 10),
    JuanPalmieri = new PositionTable(6,'Juan Palmieri', 'Guatemala', 'R1250GS', 9),
    JoseCanizalez = new PositionTable(5,'José Canizalez', 'Guatemala', 'R1250GS', 8),
    IvanNavas = new PositionTable(4,'Ivan Navas', 'Guatemala', 'R1250GS', 5),
    JorgeSoto = new PositionTable(1,'Jorge Soto', 'Guatemala', 'R1250GS', 4),
    TomyGonzalez = new PositionTable(23,'Tomy Gonzalez', 'Guatemala', 'R1250GS', 2),
    GuillermoBarraza = new PositionTable(22,'Guillermo Barraza', 'El_Salvador', 'R1250GS', 27),
    JuanFigueroa = new PositionTable(15,'Juan Figueroa', 'El_Salvador', 'R1250GS', 25),
    JoseBarraza = new PositionTable(21,'José Barraza', 'El_Salvador', 'R1250GS', 21),
    OmarPineda = new PositionTable(31,'Omar Pineda', 'El_Salvador', 'R1250GS', 15),
    JavierVasquez = new PositionTable(25,'Javier Vasquez', 'El_Salvador', 'R1250GS', 12),
    JaimeHernesto = new PositionTable(25,'Jaime Hernesto', 'El_Salvador', 'R1250GS', 8),
    FelipeDiaz = new PositionTable(28,'Felipe Diaz', 'El_Salvador', 'R1250GS', 5),
