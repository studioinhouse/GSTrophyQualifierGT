...
let bikerPositionTable = [
    ...
    LuisLopez = new PositionTable(7,'Luis Lopez', 'Guatemala', 'R1250GS', 17),
    VictorCaceres = new PositionTable(8,'Victor Cacerez', 'Guatemala', 'R1250GS', 17),
    CarlosRamos = new PositionTable(9,'Carlos Ramos', 'Guatemala', 'R1250GS', 16),
    ByronMacaria = new PositionTable(10, 'Byron Macaria', 'Guatemala', 'R1250GS',16),
    BryanCucum = new PositionTable(11,'Bryan Cucum', 'Guatemala', 'R1250GS', 15),
    AndreGuillen = new PositionTable(12,'Andres Guillen', 'Guatemala', 'R1250GS', 15),
    RicardoValenzuela = new PositionTable(13,'Ricardo Valenzuela', 'Guatemala', 'R1250GS', 15),
    LuisPira = new PositionTable(14,'Luis Pira', 'Guatemala', 'R1250GS', 14),
    JulioCastellanos = new PositionTable(15,'Julio Castellanos', 'Guatemala', 'R1250GS', 13),
    RolandoPalma = new PositionTable(16,'Rolando Palma', 'Guatemala', 'R1250GS', 12),
    ClaudioCucum = new PositionTable(17,'Claudio Cucum', 'Guatemala', 'R1250GS', 11),
    JoseBonilla = new PositionTable(18,'José Bonilla', 'Guatemala', 'R1250GS', 11),
    BryanHernandez = new PositionTable(19,'Bryan Hernández', 'Guatemala', 'R1250GS', 10),
    JorgeRevolorio = new PositionTable(20,'Jorge Revolorio', 'Guatemala', 'R1250GS', 10),
    JuanPalmieri = new PositionTable(21,'Juan Palmieri', 'Guatemala', 'R1250GS', 9),
    JoseCanizalez = new PositionTable(22,'José Canizalez', 'Guatemala', 'R1250GS', 8),
    IvanNavas = new PositionTable(23,'Ivan Navas', 'Guatemala', 'R1250GS', 5),
    JorgeSoto = new PositionTable(24,'Jorge Soto', 'Guatemala', 'R1250GS', 4),
    TomyGonzalez = new PositionTable(25,'Tomy Gonzalez', 'Guatemala', 'R1250GS', 2),
    GuillermoBarraza = new PositionTable(26,'Guillermo Barraza', 'El_Salvador', 'R1250GS', 27),
    JuanFigueroa = new PositionTable(27,'Juan Figueroa', 'El_Salvador', 'R1250GS', 25),
    JoseBarraza = new PositionTable(28,'José Barraza', 'El_Salvador', 'R1250GS', 21),
    OmarPineda = new PositionTable(29,'Omar Pineda', 'El_Salvador', 'R1250GS', 15),
    JavierVasquez = new PositionTable(30,'Javier Vasquez', 'El_Salvador', 'R1250GS', 12),
    JaimeHernesto = new PositionTable(31,'Jaime Hernesto', 'El_Salvador', 'R1250GS', 8),
    FelipeDiaz = new PositionTable(32,'Felipe Diaz', 'El_Salvador', 'R1250GS', 5),
...
let img82, img83, img84, img85, img86, img87, img88, img89, img90, img91, img92, img93, img94, img95, img96, img97, img98, img99, img100, img101, img102, img103, img104, img105, img106, img107, img108, img109, img110, img111, img112, img113, img114, img115, img116, img117, img118, img119, img120;
...
let bikerImageDay2 = [
    ...
    /*img105 = new PositionImg('GS_img24', './statics/images/GSTrophy_img_day/image-24.jpg'),
    img106 = new PositionImg('GS_img25', './statics/images/GSTrophy_img_day/image-25.jpg'),
    img107 = new PositionImg('GS_img26', './statics/images/GSTrophy_img_day/image-26.jpg'),
    img108 = new PositionImg('GS_img27', './statics/images/GSTrophy_img_day/image-27.jpg'),
    img109 = new PositionImg('GS_img28', './statics/images/GSTrophy_img_day/image-28.jpg'),
    img110 = new PositionImg('GS_img29', './statics/images/GSTrophy_img_day/image-29.jpg'),
    img111 = new PositionImg('GS_img30', './statics/images/GSTrophy_img_day/image-30.jpg'),
    img112 = new PositionImg('GS_img31', './statics/images/GSTrophy_img_day/image-31.jpg'),
    img113 = new PositionImg('GS_img32', './statics/images/GSTrophy_img_day/image-32.jpg'),
    img114 = new PositionImg('GS_img33', './statics/images/GSTrophy_img_day/image-33.jpg'),
    img115 = new PositionImg('GS_img34', './statics/images/GSTrophy_img_day/image-34.jpg'),
    img116 = new PositionImg('GS_img35', './statics/images/GSTrophy_img_day/image-35.jpg'),
    img117 = new PositionImg('GS_img36', './statics/images/GSTrophy_img_day/image-36.jpg'),
    img118 = new PositionImg('GS_img37', './statics/images/GSTrophy_img_day/image-37.jpg'),
    img119 = new PositionImg('GS_img38', './statics/images/GSTrophy_img_day/image-38.jpg'),
    img120 = new PositionImg('GS_img39', './statics/images/GSTrophy_img_day/image-39.jpg'),
    img1 = new PositionImg('GS_img40', './statics/images/GSTrophy_img_day/image-40.jpg'),
    img41 = new PositionImg('GS_img41', './statics/images/GSTrophy_img_day/image-41.jpg'),
    img42 = new PositionImg('GS_img42', './statics/images/GSTrophy_img_day/image-42.jpg'),
    img43 = new PositionImg('GS_img43', './statics/images/GSTrophy_img_day/image-43.jpg'),
    img44 = new PositionImg('GS_img44', './statics/images/GSTrophy_img_day/image-44.jpg'),
